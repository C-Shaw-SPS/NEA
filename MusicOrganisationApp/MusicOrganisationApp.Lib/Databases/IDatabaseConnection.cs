...
namespace MusicOrganisationApp.Lib.Databases
{
    public interface IDatabaseConnection
    {
        ...
        Task InsertAllAsync<T>(IEnumerable<T> values) where T : class, ITable, new();
        Task InsertAsync<T>(T value, bool getNewId = false) where T : class, ITable, new();
        ...
        Task ResetTableAsync<T>(IEnumerable<T> values) where T : class, ITable, new();
