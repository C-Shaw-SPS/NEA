...
{
    [Table(_TABLE_NAME)]
    public class PupilAvaliability : ITable, IEquatable<PupilAvaliability>, IPupilIdentifiable
    {
        private const string _TABLE_NAME = nameof(PupilAvaliability);
        ...
        public bool Equals(PupilAvaliability? other)
        {
